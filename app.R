...
ui <- fluidPage(
    ...
    # Add custom CSS while keeping your content
    tags$head(
        tags$style(HTML("
            .title-box { 
    ...
    # Wrap your existing title and descriptions in styled divs
    div(class = "title-box",
    ...
    # Keep your existing layout but add styling
    sidebarLayout(
        sidebarPanel(
            style = "background-color: white; border-radius: 5px;",
            # Your existing inputs with added styling
            div(class = "well",
        ...
        mainPanel(
            tabsetPanel(
                # Map tab - keep your descriptions, add styling
                tabPanel("Map", 
                        div(class = "well",
                ...
                # Line Graph tab - keep your content, add styling
                tabPanel("Line Graph",
                        div(class = "well",
                ...
                # Data Table tab - keep your descriptions, add styling
                tabPanel("Data Table", 
                        div(class = "well",
